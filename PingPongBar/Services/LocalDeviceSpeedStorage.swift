...
final class LocalDeviceSpeedStorage: @unchecked Sendable {
    ...
    private static let logger = Logger(subsystem: "PingPongBar", category: "LocalDeviceSpeedSQLite")
    ...
    private init() {
        ...
        let dir = appSupport.appendingPathComponent("PingPongBar", isDirectory: true)
