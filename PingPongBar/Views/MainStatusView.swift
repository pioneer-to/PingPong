...
struct MainStatusView: View {
                ...
                ScrollView {
                    LazyVStack(spacing: 0) {
                        ForEach(monitor.localDevices) { device in
                            ...
                            let isCurrentDevice = monitor.isCurrentLocalDevice(device)
                            ...
                            Button {
                                ...
                                LocalDeviceRowView(
                                    ...
                                    isInitialDataPending: !monitor.hasCompletedInitialLocalDeviceRefresh
                                )
                            }
                            .buttonStyle(.plain)
                            .contextMenu {
    ...
    private var headerRow: some View {
        VStack(alignment: .leading, spacing: 2) {
            HStack {
                Text("PingPongBar Network Monitor")
                    .font(.headline)
                Spacer()
                HStack(spacing: 8) {
                    Button {
